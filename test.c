...
// This function does the hashing in the test, calling the argon2_hash function and argon2_verify funtions. The former is important and needs to be handled. 
...
// Main calls hashtest, which calls argon2_hash in turn calling argon2_ctx. 
int main() {
    int ret;
    unsigned char out[OUT_LEN];
    char const *msg;
